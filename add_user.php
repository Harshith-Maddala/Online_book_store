...
// insert sql query
$s = "INSERT INTO `user_details`(`first_name`, `last_name`, `email`, `password`, `age`, `occupation`, `gender`, `created_date`, `created_by`, `role`, `user_status`) 
      VALUES ('$first_name', '$last_name','$email', '$password','$age', '$occupation','$gender',NOW(),'$adminId','$role', '$userStatus')";
// execute query
...
if($result){
    ...
    window.location.href='manageusers.php?id=$adminId';
    </script>";
        ...
        <div class="mt-4 flex flex-col items-center">
          <div class="w-full flex-1 mt-8">
            ...
            <form action="" method="post">
              ...
              <input type="button" value = "Cancel" onclick="location.href='manageusers.php?id=<?php echo $adminId?>';"
              class="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
            </form>
            </div>
          </div>
