...
if($_GET['id'] != null)
{
  ...
  while($row = mysqli_fetch_assoc($result)){
    ...
    {
      $actionColumn = "<input type='Button' value='Delete' onclick=\"location.href='delete_book.php?id=".$row['book_id']."&loginid=$userid'\"
    ...
    else if($row['book_status']=="Inactive")
    {
      $actionColumn = "--";
    }
    $books=$books."<tr>
...
<html>
  ...
  <br><?php echo $books ?><br>
    <div class="mx-auto max-w-xs">      
      <input type="button" value = "Add A Book" onclick="location.href='add_book.php?id=<?php echo $userid?>';"
